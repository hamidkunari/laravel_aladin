...
<router-link to="/product" class="btn btn-default btn1" style="height: 35px;">Rejected </router-link>
</div>
...
<script type="text/javascript">
  ...
  export default {
    ...
    computed:{
      filtersearch(){
      return this.products.filter(unapproved => {
         return unapproved.product_name.match(this.searchTerm)
      }) 
      }
    },
